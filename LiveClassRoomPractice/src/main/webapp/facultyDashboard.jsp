												...
												<div class="card-body">
														...
														<div class="col col-5">
															<section class="card">
																<div class="card-body text-secondary">
																	<a href="facultylectures.jsp"><b>Lectures</b></a>
																</div>
															</section>
														</div>
														<div class="col col-5">
															<section class="card">
																<div class="card-body text-secondary">
																	<a href="facultynotes.jsp"><b>Notes</b></a>
																</div>
															</section>
														</div>
													</div>
													<div class="row">
														<div class="col col-5">
															<section class="card">
																<div class="card-body text-secondary">
																	<a href="facultyqueries.jsp"><b>Queries</b></a>
																</div>
															</section>
														</div>
														<div class="col col-5">
															<section class="card">
																<div class="card-body text-secondary">
																	<a href="noticeFromAdmin.jsp"><b>Notice</b></a>
																</div>
															</section>
														</div>
													</div>
